...
router.get("/:categoryMain/view", (req, res, next) => controller.findBoard(req, res, next))
router.post("/:categoryMain/write", (req, res, next) => controller.postWrite(req, res, next))
